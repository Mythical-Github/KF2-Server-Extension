...
function SetCurrentCharacterButtons()
{
	...
	DataObject.SetString("selectedCharacter", (bIsCustomChar ? ExtPRI.CustomCharList[ExtPRI.RepCustomizationInfo.CharacterIndex].DisplayName : Localize(CharInfoPath, "CharacterName", class'KFGFxMenu_Gear'.Default.KFCharacterInfoString)));
