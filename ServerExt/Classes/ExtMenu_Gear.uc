...
function SetCurrentCharacterButtons()
{
	...
	DataObject.SetString("selectedCharacter", (bIsCustomChar ? ExtPRI.CustomCharList[ExtPRI.CharacterArchetypes.Length-ExtPRI.RepCustomizationInfo.CharacterIndex].DisplayName : Localize(CharInfoPath, "CharacterName", class'KFGFxMenu_Gear'.Default.KFCharacterInfoString)));
